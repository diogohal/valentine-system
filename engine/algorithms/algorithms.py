...
from ..algorithms.goodness_of_fitness.goodness_of_fit import GoodnessOfFit
...
instance_only_algorithms = [CorrelationClustering.__name__, GoodnessOfFit.__name__, JaccardLevenMatcher.__name__]
